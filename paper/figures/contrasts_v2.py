...
def contrasts():
    ...
    panel(0,'(c) Alternative fitting objective',
    ...
    for x,f,label in [(7,'O','Original 98.75%'),(126,'F','Checkpoints 98.33%'),
                      (275,'M','Objective 98.75%'),(409,'T','Text 98.33%')]:
        co,_=FAMILY[f];s.marker(x,214,f,co);s.text(x+7,217,label,9,color=GRAY)
    s.text(252,229,'CV27 ΔWER (percentage points); negative favors first. Panel x scales differ.',9,color=GRAY,anchor='middle')
